...
export const VOLNOVOI_SUBTITLE_LEAD = "копирует все сделки";
export const VOLNOVOI_SUBTITLE_ACCENT = "ТОП Трейдеров";
...
export const DISCLAIMER_POINTS = [
  ...
  "Cult показывает сделки открыто, не заряжать все 100% депо в одну сделку, даже если трейдер самый топовый — любая сделка может быть провальной.",
] as const;

  ...
  table_rows: [
    {
      ...
      hint: "% прибыли от старта этапа.",
      values: ["8%", "6%", "∞"],
    },
    {
      id: "max_daily_loss",
      label: "Максимальная потеря в день",
      hint: "Макс. убыток за день, % от баланса на утро.",
      values: ["5%", "5%", "5%"],
    },
    {
      id: "max_drawdown",
      label: "Макс просадка",
      hint: "Просадка от депозита челленджа.",
      values: ["10%", "8%", "8%"],
    },
    {
      id: "min_trading_days",
      label: "Мин. торговые дни",
      hint: "Дней с хотя бы одной сделкой.",
      values: ["5", "5", "∞"],
    },
    {
      id: "trading_period",
      label: "Торговый период",
      hint: "Срок этапа (∞ — без лимита).",
      values: ["∞", "∞", "∞"],
    },
    {
      id: "max_leverage",
      label: "Максимальное кредитное плечо",
      hint: "Плечо на крипте.",
      values: ["1:5", "1:5", "1:5"],
    },
  ],
};
